package io.delta.oms;
public  class TestMain$ implements io.delta.oms.common.OMSRunner, io.delta.oms.common.OMSInitializer {
  /**
  ...
  public   TestMain$ ()  { throw new RuntimeException(); }
